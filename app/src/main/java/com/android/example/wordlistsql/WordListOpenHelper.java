...
// 1.3 Build SQL Query and Code To Create Database
    ...
    private void fillDatabaseWithData(SQLiteDatabase db) {
        String[] words = {"Kunyit 2 ons", "Beras 5Kg", "Minyak Sayur 2 liter", "Ayam Potong 2Kg",
                "Jeruk 2Kg", "Gula 1/2Kg", "Pasta Gigi Merk X",
                "Shampo 1 botol 600ml", "Sabun 1 botol 600ml","Detergen cair 250ml",
                "Softener 250ml"};
// 1.4 - 5
